...
<!-- Modal -->
<div class="modal fade" id="getStarted" role="dialog" aria-labelledby="getStartedLabel">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h2 class="modal-title" id="getStartedLabel">Get started with Pulsir.</h4>
      </div>
      <div class="modal-body">
  <p>It's fast, easy and free.</p>


  <form action="signup.php" method="post" id="hash" role="form" class="form">
    ...
    <div class="form-group">
      ...
      <input type="email" name="email" id="email" placeholder="Your email. Important things only, used for Gravatar." class="form-control" required />
    </div>
...
<div class="container">
 ...
 <div class="features">
   ...
   <div class="row"><div class="col-md-4">
     ...
     <p>Focus on <b>writing</b>, not messing around with complicated settings.</p>
...
<h3><i class="icon-code-fork"></i> Open source </h3>
<p>Want to contribute? Hate how something works? Want to add something new? The complete code is up on <a href="http://github.com/pulsir/pulsir">GitHub</a>.</p>
</div><div class="col-md-4">
...
<div class="text-center">
  ...
  <h2>Some of the best stories on Pulsir.</h2>
  <div class="spotlight">
    <div class="row">
      <div class="col-md-4">
...
<p>And with Pulsir, it's a piece of cake. Just let your self go, type away, and you'll have a beautiful story just like that.</p>
</div>
</div>
