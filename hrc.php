...
// Avatar Hash
$avhash = md5( strtolower( trim( "m1k1m0t0@seznam.cz" ) ) );

// User data
$ud_username = 'hrc';
$ud_userbadge = '';
$ud_tagline = "A blog on undefined.";
$ud_sidebar = '';
?>
<!DOCTYPE html>
...
?>
</a><a href="http://pulsir.eu//<?php echo $ud_username; ?>"> <?php echo $ud_username; ?> <span class="badge"> <?php echo $ud_userbadge; ?></span></a></h3>
